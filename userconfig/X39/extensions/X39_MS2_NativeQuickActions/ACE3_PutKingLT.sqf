...
_actionIndex = ["PUTKINGLT"] call X39_MS2_fnc_getActionById;
if(_actionIndex == -1) exitWith {PRINT_ERROR("Cannot get Native XMS2 action 'PUTKINGLT'"); false};

[
	localize "STR_X39_MS2_Scripting_QuickActions_ACE3_PutKingLT_Name",
	parseText "",
