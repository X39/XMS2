...
_actionIndex = ["STARTCPR"] call X39_MS2_fnc_getActionById;
if(_actionIndex == -1) exitWith {PRINT_ERROR("Cannot get Native XMS2 action 'STARTCPR'"); false};

[
	localize "STR_X39_MS2_Scripting_QuickActions_ACE3_StartCPR_Name",
	parseText "",
