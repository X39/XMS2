...
_actionIndex = ["USEBAGVALVEMASK"] call X39_MS2_fnc_getActionById;
if(_actionIndex == -1) exitWith {PRINT_ERROR("Cannot get Native XMS2 action 'USEBAGVALVEMASK'"); false};

[
	localize "STR_X39_MS2_Scripting_QuickActions_ACE3_UseBagvalveMask_Name",
	parseText "",
