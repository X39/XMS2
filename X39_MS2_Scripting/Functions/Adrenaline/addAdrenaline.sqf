...
_max = if(count _this >= 3 && {_this select 2}) then {X39_MS2_var_Adrenaline_maxAdrenaline * X39_MS2_var_Adrenaline_naturalAdrenalineP} else {X39_MS2_var_Adrenaline_maxAdrenaline};
