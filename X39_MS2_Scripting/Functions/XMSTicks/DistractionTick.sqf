...
_unit setVariable["X39_MS2_var_Internal_Ticker_ppeWetDisort_LeftStrength", _distraction];
_unit setVariable["X39_MS2_var_Internal_Ticker_ppeWetDisort_RightStrength", _distraction];
