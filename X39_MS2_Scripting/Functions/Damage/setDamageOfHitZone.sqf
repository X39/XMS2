...
{
	["DamageChanged_%1", _this, false, "XMS2", missionNamespace] call X39_XLib_EH_fnc_triggerEvent;
};
(_this select 0) setVariable ["X39_MS2_var_Damage_%1", _this select 1, false];