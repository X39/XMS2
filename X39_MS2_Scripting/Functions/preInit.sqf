...
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_UnitInitialized",				{false												}, true	,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_Damage_LastHitter", 			{objNull											}, true	,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_Bleeding_Blood",				{X39_MS2_var_Bleeding_maxBloodInEntireBody      	}, true	,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_Bleeding_Clotting",			{1													}, true	,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_EH_HandleDamage",				{-1													}, false,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_EH_FiredNear",				{-1													}, false,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_EH_Explosion",				{-1													}, false,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_EH_AnimStateChanged",			{-1													}, false,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_EH_Respawn",					{-1													}, false,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_EH_HitPart",					{-1													}, false,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_Heart_heartPulse",			{X39_MS2_var_Heart_minHeartPulsePerSecond	    	}, true	,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_Heart_hasFlatLine",			{-1													}, true	,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_Heart_cprPresent",			{false												}, true	,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_Heart_cprCount",				{0													}, true	,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_Pain_value",					{0													}, true	,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_Hearing_value",				{1													}, true	,										true	,				false	];
...
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_BlackOut_Text",				{""													}, false,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_BlackOut_isBlackedOut",		{false												}, true	,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_BlackOut_currentStage",		{0													}, true	,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_BlackOut_timeOfUnconscious",	{-1													}, true	,										true	,				false	];
...
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_Drugs_Aspirin_value",			{0													}, true	,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_distraction",					{0													}, true	,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_respiratory_value",			{X39_MS2_var_Respiratory_maxValue				    }, true	,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_respiratory_toungeBlocking",	{false												}, true	,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_respiratory_arrestPresent",	{false												}, true	,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_lsClass",						{-1													}, false,										true	,				true	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_UnitTickHandle",				{scriptNull										    }, false,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["X39_MS2_var_isUnitInOpenArea",			{false												}, false,										true	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["tf_unable_to_use_radio",					{true												}, true	,										false	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["tf_voiceVolume",							{1													}, true	,										false	,				false	];
X39_MS2_var_Internal_UnitVariables pushBack ["tf_globalVolume",							{1													}, true	,										false	,				false	];
{
